                ...
                <div className='popup__text-wrapper'>
                    <div className='popup__text-wrap'>
                        ...
                        <p className='popup__text'>
                            Здесь представлена коллекция карточек<br/>  
                            Покемонов, которые ты сможешь использовать<br/> 
                            в дуэли против вражеских Покемонов.<br/><br/>

                            <b>Важный совет:</b> открывай, улучшай и анализируй<br/>
                            Покемонов после каждой дуэли, так как<br/>
                            каждый Покемон по своему уникален.<br/><br/>
